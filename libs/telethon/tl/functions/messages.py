...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReplyMarkup, TypeInputDialogPeer, TypeInputEncryptedFile, TypeShippingOption, TypeInputSingleMedia, TypeInputMessage, TypeSendMessageAction, TypeInputStickerSet, TypeChatBannedRights, TypeInputChatPhoto, TypeInlineBotSwitchPM, TypeInputStickeredMedia, TypeMessageEntity, TypeInputGeoPoint, TypeInputBotInlineMessageID, TypeInputDocument, TypeMessagesFilter, TypeInputPeer, TypeBool, TypeInputEncryptedChat, TypeInputMedia, TypeInputBotInlineResult, TypeInputUser, TypeReportReason
