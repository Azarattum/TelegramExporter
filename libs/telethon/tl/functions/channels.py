...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeChatAdminRights, TypeInputMessage, TypeBool, TypeInputUser, TypeInputChannel, TypeInputStickerSet, TypeChatBannedRights
