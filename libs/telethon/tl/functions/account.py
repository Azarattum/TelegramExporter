...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeerNotifySettings, TypeInputFile, TypeInputSecureValue, TypeInputPrivacyRule, TypeSecureValueType, TypeInputWallPaper, TypeSecureCredentialsEncrypted, TypeBool, TypeInputPeer, TypeInputNotifyPeer, TypeAccountDaysTTL, TypeInputPrivacyKey, TypeReportReason, TypeInputCheckPasswordSRP, TypeSecureValueHash
