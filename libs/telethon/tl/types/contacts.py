...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypePeer, TypeTopPeerCategoryPeers, TypeContactLink, TypeImportedContact, TypePopularContact, TypeContactBlocked, TypeContact, TypeUser
