...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeChatFull, TypeChat, TypeEncryptedFile, TypeStickerSet, TypeStickerPack, TypeDialog, TypeStickerSetCovered, TypeFoundGif, TypeMessage, TypeUser, TypeHighScore, TypeBotInlineResult, TypeDocument
